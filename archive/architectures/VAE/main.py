...
train_data = datasets.MNIST(
    "~/Documents/datasets/", train=True, transform=transform, download=True
)

test_data = datasets.MNIST("~/Documents/datasets/", train=False, transform=transform)
...
for epoch in tqdm(range(start_epoch, args.epochs + 1)):
    ...
    with torch.no_grad():
        ...
        save_image(sample.view(64, 1, 28, 28), f"./outputs/sample_{str(epoch)}.png")
if args.save_model:
