...
def train(
    ...
    for i, ((imgs1, _), (imgs2, _)) in tqdm(
        enumerate(zip(train_loader, train_loader2))
    ):
        ...
        g_loss = (
            adversarial_loss(validity1, valid) + adversarial_loss(validity2, valid)
        ) / 2
        ...
        if batches_done % args.log_interval == 0:
            ...
            save_image(
                gen_images, f"outputs/{batches_done}.png", nrow=8, normalize=True
            )
