...
class LitModel(pl.LightningModule):
    def __init__(self, learning_rate=0.1, weight_decay=0.0001, margin=1, img_size=64):
        super().__init__()
...
class ImageClassDs(Dataset):
    def __init__(self, img_ds, train: bool = True, transforms=None, should_invert=None):
        self.img_ds = img_ds
        self.train = train
...
class ImDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        dataset = ImageClassDs(
            img_ds=self.DatasetFolder, transforms=self.train_transform
        )
...
dm = ImDataModule(
    batch_size=batch_size, img_size=img_size, data_dir="/media/hdd/Datasets/celeba/"
)
class_ids = dm.setup()
